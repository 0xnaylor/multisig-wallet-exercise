...
contract MultiSignatureWallet {
    ...
    event Deposit(address indexed sender, uint value); // indexed = more searchable
    ...
    function confirmTransaction(uint transactionId) public {
        require(isOwner[msg.sender]);
        // Below: check that a transaction exists at the specified transactionId
    ...
    function isConfirmed(uint transactionId) internal view returns (bool) {
        // verfiy that the tansaction has the required number of confirmations
        // loop over the owners array and count how many of the owners have confirmed the transaction.
        uint count = 0;
